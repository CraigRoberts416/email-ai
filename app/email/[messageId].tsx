      ...
      <View style={cardStyles.actionBar}>
        <View style={cardStyles.actionsGroup}>
          <Pressable style={cardStyles.actionBtn} hitSlop={8}>
            <IconSymbol name="face.smiling" size={16} color={Theme.textPrimary} />
          </Pressable>
          <Pressable style={cardStyles.actionBtn} hitSlop={8}>
            <IconSymbol name="arrow.turn.up.left" size={16} color={Theme.textPrimary} />
          </Pressable>
          <Pressable style={cardStyles.actionBtn} hitSlop={8}>
            <IconSymbol name="arrow.turn.up.right" size={16} color={Theme.textPrimary} />
          </Pressable>
        </View>
        <View style={cardStyles.actionsGroup}>
          <Pressable style={cardStyles.actionBtn} hitSlop={8}>
            <IconSymbol name="bookmark" size={16} color={Theme.textPrimary} />
          </Pressable>
          <Pressable style={cardStyles.actionBtn} hitSlop={8}>
            <IconSymbol name="trash" size={16} color={Theme.textPrimary} />
          </Pressable>
        </View>
      </View>
    </View>
          ...
          <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.headerOverlay}>
              ...
              <View style={styles.threadCountRow}>
                <IconSymbol name="bubble.left.and.bubble.right" size={14} color={Theme.textSecondary} />
